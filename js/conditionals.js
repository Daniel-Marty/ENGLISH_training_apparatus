...
function testPC() {
    ...
    if (testRandomNumber === 0) {
        testPCcallback('she.jpg', '2.png', 'sleep.gif', PCStyle, ' ', 'when', 'he.jpg', '1.png', 'come.gif', PSStyle, "She wasn't sleeping when he came"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 1) {
        testPCcallback('he.jpg', '1.png', 'read.gif', PCStyle, ' ', 'when', 'she.jpg', '1.png', 'call.gif', PSStyle, "He was reading when she called"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 2) {
        testPCcallback('he.jpg', '1.png', 'study.gif', PCStyle, ' ', 'while', 'she.jpg', '1.png', 'cook.gif', PCStyle, "He was studying when she was cooking"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 3) {
        testPCcallback('you.jpg', '1.png', 'arrive.gif', PSStyle, ' ', 'while', 'me.jpg', '1.png', 'work.gif', PCStyle, "You arrived while I was working"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 4) {
        testPCcallback('you.jpg', '1.png', 'eat.gif', PCStyle, ' ', 'while', 'me.jpg', '1.png', 'drive.gif', PCStyle, "You were eating while I was driving"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 5) {
        testPCcallback('you.jpg', '3.png', 'play.gif', PCStyle, ' ', 'while', 'me.jpg', '1.png', 'clean.gif', PCStyle, "Were you playing while I was cleaning?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 6) {
        testPCcallback('we.jpg', '1.png', 'watch.gif', PCStyle, 'As', '', 'he.jpg', '1.png', 'disappear.gif', PSStyle, "As we were watching he disappeared"), firstIf.classList.remove('hidden'), secondWould.classList.add('hidden')
    } else if (testRandomNumber === 7) {
        testPCcallback('she.jpg', '3.png', 'be angry.gif', PSStyle, '', 'when', 'he.jpg', '1.png', 'surf the internet.gif', PCStyle, "Was she angry when he was surfing the internet?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 8) {
        testPCcallback('they.jpg', '1.png', 'smoke.gif', PCStyle, '', 'so', 'they.jpg', '1.png', 'start talking.gif', PSStyle, "They were smoking so they started talking"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
     } else if (testRandomNumber === 9) {
        testPCcallback('she.jpg', '2.png', 'show true colors.jpg', PSStyle, '', 'while', 'we.jpg', '1.png', 'travel.gif', PCStyle, "She didn't show her true colors while we were traveling"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
     } else if (testRandomNumber === 10) {
        testPCcallback('it.jpg', '3.png', 'rain.gif', PCStyle, '', 'when', 'she.jpg', '1.png', 'go out.gif', PSStyle, "Was it raining when she went out?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 11) {
        testPCcallback('it.jpg', '2.png', 'rain.gif', PCStyle, '', 'when', 'it.jpg', '1.png', 'plane take off.gif', PSStyle, "It wasn't raining when the plane took off"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 12) {
        testPCcallback('he.jpg', '1.png', 'hesitate.gif', PSStyle, '', 'but', 'they.jpg', '1.png', 'get married.gif', PSStyle, "He hesitated but they got married"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 13) {
        testPCcallback('it.jpg', '3.png', 'happen.gif', PSStyle, '', 'while', 'you.jpg', '1.png', 'have picnic.gif', PCStyle, "Did it happen while  you were having a picnic?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 14) {
        testPCcallback('it.jpg', '2.png', 'happen.gif', PSStyle, '', 'when', 'she.jpg', '1.png', 'get in.gif', PSStyle, "It didn't happen when she got in"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
     } else if (testRandomNumber === 15) {
        testPCcallback('it.jpg', '1.png', 'happen.gif', PSStyle, '', 'when', 'we.jpg', '1.png', 'pass exam.gif', PCStyle, "It happened when we were passing the exam"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 16) {
        testPCcallback('me.jpg', '2.png', 'get embarrassed.gif', PSStyle, '', 'so', 'she.jpg', '2.png', 'get dressed.gif', PSStyle, "I didn't get embarrassed so she didn't get dressed"), firsfirstIftWould.classList.add('hidden'), secondWould.classList.remove('hidden')
      } else if (testRandomNumber === 17) {
        testPCcallback('we.jpg', '1.png', 'run out of time.gif', PCStyle, '', 'so', 'we.jpg', '1.png', 'run.gif', PSStyle, "We were running out of time so we ran"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 18) {
        testPCcallback('he.jpg', '2.png', 'be late.gif', PSStyle, '', 'so', 'he.jpg', '2.png', 'panic.gif', PSStyle, "He wasn't late so he didn't panic"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
     } else if (testRandomNumber === 19) {
        testPCcallback('we.jpg', '1.png', 'be late.gif', PSStyle, '', 'so', 'we.jpg', '1.png', 'rush.gif', PSStyle, "We were late so we rushed"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
     } else if (testRandomNumber === 20) {
        testPCcallback('you.jpg', '3.png', 'make coffee.gif', PCStyle, '', 'when', 'he.jpg', '1.png', 'pass by.gif', PSStyle, "Were you making coffee when he passed by?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 21) {
        testPCcallback('she.jpg', '1.png', 'attract attention.gif', PCStyle, '', 'but', 'nobody.jpg', '1.png', 'come.gif', PSStyle, "She was attracting attention but nobody came"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
    } else if (testRandomNumber === 22) {
        testPCcallback('me.jpg', '2.png', 'interrupt.gif', PSStyle, '', 'when', 'you.jpg', '1.png', 'speak.gif', PCStyle, "I didn't interrupt when you were speaking"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden')
     } else if (testRandomNumber === 23) {
        testPCcallback('you.jpg', '1.png', 'arrive.gif', PSStyle, 'when', '', 'he.jpg', '3.png', 'dance.gif', PCStyle, "When you arrived was he dancing?"), firstIf.classList.remove('hidden'), secondWould.classList.add('hidden');
    } else if (testRandomNumber === 24) {
        testPCcallback('you.jpg', '1.png', 'argue.gif', PCStyle, 'when', '', 'he.jpg', '3.png', 'lie on the ground.gif', PCStyle, "When you were arguing was he lying on the ground?"), firstIf.classList.remove('hidden'), secondWould.classList.add('hidden');
    } else if (testRandomNumber === 25) {
        testPCcallback('me.jpg', '1.png', 'come up.gif', PSStyle, '', 'when', 'she.jpg', '1.png', 'sing.gif', PCStyle, "I came up when she was singing"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 26) {
        testPCcallback('you.jpg', '3.png', 'go.gif', PCStyle, 'Where', 'when', 'me.jpg', '1.png', 'see.gif', PSStyle, "Where were you going when I saw you?"), firstIf.classList.remove('hidden'), secondWould.classList.remove('hidden');
     } else if (testRandomNumber === 27) {
        testPCcallback('he.jpg', '1.png', 'point out.gif', PSStyle, '', 'because', 'she.jpg', '2.png', 'look.gif', PCStyle, "He pointed out because she wasn't looking"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
     } else if (testRandomNumber === 28) {
        testPCcallback('she.jpg', '3.png', 'wear.gif', PCStyle, 'What', 'when', 'you.jpg', '1.png', 'see.gif', PSStyle, "What was she wearing when you saw her?"), firstIf.classList.remove('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 29) {
        testPCcallback('he.jpg', '3.png', 'get embarrassed.gif', PSStyle, '', 'when', 'he.jpg', '1.png', 'fart.gif', PSStyle, "Did he get embarrassed when he farted?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
     } else if (testRandomNumber === 30) {
        testPCcallback('she.jpg', '1.png', 'panic.gif', PSStyle, '', 'when', 'he.jpg', '1.png', 'figure out.gif', PSStyle, "She panicked when he figured out"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 31) {
        testPCcallback('they.jpg', '1.png', 'speak.gif', PCStyle, 'While', '', 'she.jpg', '1.png', 'reveal.gif', PSStyle, "While they were speaking she revealed"), firstIf.classList.remove('hidden'), secondWould.classList.add('hidden');
     } else if (testRandomNumber === 32) {
        testPCcallback('she.jpg', '3.png', 'cry.gif', PCStyle, '', 'when', 'she.jpg', '1.png', 'miss train.gif', PSStyle, "Was she crying when she missed the train?"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 33) {
        testPCcallback('they.jpg', '3.png', 'look for.gif', PCStyle, 'What', 'when', 'cat.jpg', '1.png', 'come back.gif', PSStyle, "What were they looking for when the cat came back?"), firstIf.classList.remove('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 34) {
        testPCcallback('he.jpg', '3.png', 'be sarcastic.gif', PSStyle, '', 'while', 'you.jpg', '1.png', 'explain.gif', PCStyle, "Was he sarcastic while you were explaining?"), firstIf.classList.remove('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 35) {
        testPCcallback('nobody.jpg', '1.png', 'leave.gif', PCStyle, '', 'because', 'nobody.jpg', '1.png', 'have to.gif', PSStyle, "Nobody was leaving because nobody had to"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 36) {
        testPCcallback('nobody.jpg', '1.png', 'watch.gif', PCStyle, '', 'so', 'she.jpg', '1.png', 'take off clothes.gif', PSStyle, "Nobody was watching so she took off clothes"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
     } else if (testRandomNumber === 37) {
        testPCcallback('he.jpg', '1.png', 'teach.gif', PCStyle, '', 'because', 'nobody.jpg', '1.png', 'know.gif', PSStyle, "He was teaching because nobody knew"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 38) {
        testPCcallback('nobody.jpg', '1.png', 'be interested.gif', PSStyle, '', 'because', 'they.jpg', '2.png', 'win.gif', PCStyle, "Nobody was interested because they weren't winning"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 39) {
        testPCcallback('nobody.jpg', '1.png', 'throw up.gif', PCStyle, '', 'because', 'she.jpg', '2.png', 'drive.gif', PCStyle, "Nobody was throwing up because she wasn't driving"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    } else if (testRandomNumber === 40) {
        testPCcallback('nobody.jpg', '1.png', 'hide.gif', PCStyle, '', 'because', 'they.jpg', '2.png', 'come in.gif', PSStyle, "Nobody was hiding because they didn't come in"), firstIf.classList.add('hidden'), secondWould.classList.remove('hidden');
    }
...
function testPCcallback(who, mark1pic, verb1, style1, modal1, modal2, who2, mark2sign, verb2, style2, sentence) {
    ...
    firstIf.style.opacity = '1';
    firstIf.innerHTML = `${modal1}`
