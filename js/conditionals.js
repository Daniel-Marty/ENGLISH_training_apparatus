...
let second_verbs_array = ['want.jpg', 'have_to.gif', 'throw_up.gif', 'get_dirty.gif', 'nod.gif', 'write.gif', 'work.gif', 'win.gif', 'walk.gif', 'wait.gif', 'try.gif', 'travel.gif', 'think.gif', 'teach.gif', 'take_off_clothes.gif', 'swim.gif', 'suggest.gif', 'stay.jpg', 'start_talking.gif', 'spin.gif', 'smoke.gif', 'sleep.gif', 'run.gif', 'repeat.gif', 'remind.gif', 'realize.gif', 'read.gif', 'pay.gif', 'panic.gif', 'overtake.gif', 'make_coffee.gif', 'make_a_bed.gif', 'lose_weight.gif', 'look_for.gif', 'listen.gif', 'like.gif', 'lie.gif', 'let_go.gif', 'leave.gif', 'jump.gif', 'interrupt.gif', 'hide.gif', 'hesitate.gif', 'hear.gif', 'go_out.gif', 'get_fat.gif', 'figure_out.gif', 'feel_sick.gif', 'disappear.gif', 'fall.gif', 'fart.gif', 'escape.gif', 'drink.gif', 'drive.gif', 'forget.gif', 'deny.gif', 'come.gif', 'come_up.gif', 'come_back.gif', 'recommend.gif' ]
